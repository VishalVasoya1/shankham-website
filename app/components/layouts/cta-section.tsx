            ...
            <div className="relative rounded-2xl p-12 md:p-16 backdrop-blur-sm">
              ...
              <div className="relative z-10 text-center max-w-3xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <button
                    className="group relative inline-flex items-center justify-center gap-2 px-8 py-4 rounded-xl border-2 bg-background/50 backdrop-blur-sm font-semibold text-base transition-all hover:scale-105 hover:border-primary/50 hover:bg-background w-full sm:w-auto"
